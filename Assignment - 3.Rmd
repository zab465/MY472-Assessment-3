...
Most of the data being after the mean, I choose to divide the popularity measures into quartiles (very low popularity, low popularity, popular, very popular) to distinguish popularity amongst a popular group. 
...
50 artists fall in the top 50% popularity scores, suggesting 50% of the "best artists of all time" endured through 2023 under this definition. Considering the measure reflects entire discographies, I repeat the process for only artists’ top 10 tracks, limiting the downward effect of unpopular/remastered tracks.
...
cat("The number of artists in the list having at least one popular and one very popular song is:", length(unique(pop_tracks$artists_id)))
```
...
Figure 5 reveals significant correlations only between energy and acousticness, and energy and loudness among the top 50 artists' tracks. No significant correlation exists between popularity and any other variable. While based only on 10 tracks, it is expected that top-performing tracks reflect endurance-inducive characteristics.
